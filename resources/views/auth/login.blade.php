@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Daeng Kurir Makasar')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('Login Untuk Memasuki laman dashboard') }} </h3>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <!-- <span class="bmd-help">E.g admin@mail.com</span> -->
              </div>
              @if ($errors->has('email'))
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              ...
              @endif
              <!-- <span class="bmd-help">Password must be at least 8 characters!</span> -->
            </div>
