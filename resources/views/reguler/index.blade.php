@extends('layouts.app', ['activePage' => 'reguler', 'titlePage' => __('Order Reguler')])
@push('css')
<style>
    .page {
        width: 145mm;
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12 " id="form-create" style="display:none">
                <form method="post" action="{{route('create.reguler')}}" class="form-horizontal">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                    ...
                                    <!-- input type hide untuk menampung harga -->
                                    <input type="hidden" name="specialPickupFee" id="specialPickupFee" value="0">
                                    <input type="hidden" name="specialDeliveryFee" id="specialDeliveryFee" value="0">
                                    <hr />
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group bmd-form-group">
                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group bmd-form-group">
                                                ...
                                                <input type="number" class="form-control" name="weight" id="weight" number="true" required="true" min=0 disabled="true">
                                                <span class="bmd-help">*wajib.</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group bmd-form-group">
                                                ...
                                                <input type="text" class="form-control" name="delivery_fee" id="delivery_fee" number="true" required="true" min=0 value=0 readonly>
                                                <span class="bmd-help">Penerima Paket.</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group bmd-form-group">
                                                    <select class="customers form-control" id="delivery_driver" name="delivery_driver" data-style="select-with-transition" >
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">All Order Reguler Today</h4>
                    </div>
                    <div class="card-body">
                        <div class="toolbar">
                            <div class="row">
                                    ...
                                    <div class="card ">
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <a href="{{route('order.excel')}}" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Excel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#user_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // console.log(data);
                    del_fee_lists.push(data.del_fee_list)
                    $('#specialPickupFee').val(data.price);
                    $('#weight').val(null);
        ...
        $("#weight").on('input', function(e) {
            let deliv_fee = $('#specialDeliveryFee').val();
            let pickup_fee = $('#specialPickupFee').val();
            let w = this.value;
            var values = 0;

            del_fee_lists[0].forEach(item => {
                if (w > parseInt(item.from_weight) && w <= parseInt(item.to_weight)) {
                    values = parseInt(item.price) + parseInt(deliv_fee) + parseInt(pickup_fee)
                }
            });
            delivery_fee.value = formatRupiah(values.toString(), "");
        });
        ...
        var tables = $("#datatables").DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row) {
                        ...
                        return ("<input type='checkbox' id='data_id' class='dt-checkboxes' name='update' style='zoom: 2.0;'>")
                    },
                },
                {
